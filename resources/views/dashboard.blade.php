                        ...
                        <ul class="my-4 space-y-3">
                            @if (Auth::user()->is_admin)
                                ...
                                <a href="{{ route('admin.index') }}"
                                    ...
                                    <span
                                        class="inline-flex items-center justify-center px-2 py-0.5 ms-3 text-xs font-medium text-gray-500 bg-gray-200 rounded dark:bg-gray-700 dark:text-gray-400">Special</span>
                                </a>
                            </li>
                            @endif
                        </ul>
